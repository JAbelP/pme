    ...
    <div className="flex flex-col justify-center items-center gap-y-1">
      {page === 0 ? (
        <>
          ...
          <button
            className="bg-yellow-400 text-white h-10 w-[15rem] md:w-[24rem]"
        ...
        <>
          ...
          <button
            className="bg-yellow-200 text-black h-10 w-[35rem] md:w-[24rem] mb-3"
            onClick={increasePage}
          >
            Schedule NOW
          </button>
      ...
      <p className="text-yellow-200 text-3xl mt-2">(919) 557-4477</p>
    </div>
  );
};
